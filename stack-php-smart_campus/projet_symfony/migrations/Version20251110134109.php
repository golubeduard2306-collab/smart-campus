 ...
 */
final class Version20251110134109 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE demande (id INT AUTO_INCREMENT NOT NULL, systeme_acquisition_id INT NOT NULL, id_demande INT NOT NULL, type_demande VARCHAR(20) NOT NULL, date_demande DATETIME NOT NULL, status VARCHAR(20) NOT NULL, INDEX IDX_2694D7A53572D180 (systeme_acquisition_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE demande ADD CONSTRAINT FK_2694D7A53572D180 FOREIGN KEY (systeme_acquisition_id) REFERENCES systeme_acquisition (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE demande DROP FOREIGN KEY FK_2694D7A53572D180');
